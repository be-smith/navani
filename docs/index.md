...
It is now advised to install navani using [uv](https://docs.astral.sh/uv/), to manage dependencies.
...
```
<img src="Example_figures/Graphite_charge_discharge_plot.png" alt="Graphite charge discharge plot example" width="50%" height="50%">
...
<img src="Example_figures/Graphite_dqdv.png" alt="Graphite dQ/dV plot example" width="50%" height="50%">
...
fig, ax = ec.multi_dqdv_plot(df, cycles=cycles,
                    ...
                    final_smooth=True)
```
<img src="Example_figures/Si_dQdV.png" alt="Si dQ/dV plot example" width="50%" height="50%">
